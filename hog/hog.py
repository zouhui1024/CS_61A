...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    p = (player_score % 100) % 10
    o = (opponent_score % 100) // 10
    if p == o:
        return 1
    else:
        return 3 * abs(p - o)
...
def play(strategy0, strategy1, update, score0=0, score1=0, dice=six_sided, goal=GOAL):
    ...
    while ((score0 < goal) and (score1 < goal)):
        print('DEBUG: score1 type', type(score1))
        if who == 0:
...
def make_averaged(original_function, times_called=1000):
    ...
    def averaged_dice(*args):
        ...
        average_score = total / times_called
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    Suss Fuss rules."""
    # BEGIN PROBLEM 11
    temp_score = simple_update(0, score, opponent_score)
    temp_score = sus_update(0, score, opponent_score)
    if temp_score - score >= threshold:
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
